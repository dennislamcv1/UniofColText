...
data1 = read_json("News_Category_Dataset_v2.1.json")
data1
...
data100 = read_json("News_Category_Dataset_v2.100.json", lines=True)
data100[0:3]
...
data = read_json("News_Category_Dataset_v2.json.gz", lines=True)
data[0:3]
